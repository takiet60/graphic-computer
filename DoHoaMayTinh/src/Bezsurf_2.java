...
public class Bezsurf_2 extends GLCanvas {
	
	private static final float ctrlpoints[][][] ={
			{{-3.5f, -1.5f,  4.0f},{-.5f, -1.5f,  2.0f},{ .5f, -1.5f, 2.0f},{ 3.5f, -1.5f,  4.0f}},
			{{-3.5f, -.5f,  2.0f},{-0.5f, -0.5f,  .0f},{ 0.5f, -.5f,  0.0f},{ 3.5f, -0.5f, 2.0f}},
			{{-3.5f,  -0.5f,  2.0f},{-0.5f,  0.5f,  0.0f},{ 0.5f,  .5f,  .0f},{ 3.5f,  0.5f,  2.0f}},
...
//		myGL.glRotatef(85.0f, 1.0f, 1.0f, 1.0f);
	...
	static public void main(String args[]) throws IOException{
		...
		Bezsurf_2 mainCanvas = new Bezsurf_2();
		mainCanvas.init();
